        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                <a class="sidebar-brand" href="#">
                    <span class="align-middle">Dashboard Design <i class="fa fa-times" aria-hidden="true" onclick="closesidebarmenu()"></i>
                    </span>
                ...
                <ul class="unorder-list">
                    ...
                    <li class="list-itmes">
                        <a class="nav-link collapsed dropdown-toggle text-left botton-ahref" href="#collapseExample2" role="button" data-toggle="collapse">
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <nav class="navbar navbar-expand navbar-light" style="padding: 0.9rem!important;" id="my-navbar-close">
                        ...
                        <!-- Sidebar Toggle (Topbar) -->
                            ...
                            <div type="button" id="bar" class="nav-icon1 hamburger animated fadeInLeft is-closed" onclick="opensidebarmenu()">
                                <span></span>
                                <span></span>
                                <span></span>
                            </div>
                        ...
                        <ul class="navbar-nav  ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle navbar-link-style text-dark" style="color:black !important;padding: 0.5rem 1rem!important;" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
