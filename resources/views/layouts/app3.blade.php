        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="" onclick="opendash()">
                        <a href="/dashboard" class="nav-link text-left " role="button" aria-haspopup="true" aria-expanded="false">
                        <span>
                    ...
                    <li>
                    <a href="/add_product" class="nav-link text-left" role="button">
                    <i class="fa fa-object-group" aria-hidden="true"></i>
                    Add Product
                    </a>
                    </li>
                    <li>
                    <a href="/add_pos" class="nav-link text-left" role="button">
                    ...
                    <ul class="navbar-nav  ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle navbar-link-style text-dark" style="color:black !important;"
                                href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>

                                <div  class="dropdown-menu" aria-labelledby="navbarDropdown" style="margin-left:-73% !important;">
